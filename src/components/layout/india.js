...
export default function India( { category, articles, pageArticles, totalPages } ) {
  return (
    <>
      ...
      <TenthSegment  top='300px' category={category} totalPages={totalPages} pageArticles={pageArticles} articles={articles.slice(0,3)}/>
