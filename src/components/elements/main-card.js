  ...
  return (
    <div className='main-card-container' style={{height: `${height}` ,width: `${width}` }}>
        <div className='main-card'>
            <a href={(articles)?articles[0].url:''} rel='noreferrer' target='_blank'>
                <div className={`main-card main-card-1 ${(showCard1)? "":"hide"}`}>

                    <div className="main-card-image-container">
                        {
                            (articles && articles.length>0) ?
                                (<img className={`main-card-image`} src={(articles[0].urlToImage)?articles[0].urlToImage: './site-logo-b&w.png'} alt='mac' /> )
                                :(
        ...
        <div className='main-card'>
            <a href={articles?articles[1].url:''} rel='noreferrer' target='_blank'>
                <div className={`main-card main-card-2 ${(showCard1) ? "hide" : ""}`}>
                    <div className="main-card-image-container">
                        {
                            (articles && articles.length>0) ?
                                <img className={`main-card-image`} src={(articles[1].urlToImage)?(articles[1].urlToImage): './site-logo-b&w.png'} alt='mac' /> :
                                <div className="image-placeholder placeholder" />
                        }
                    </div>
                    {
